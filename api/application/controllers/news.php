...
class news extends REST_Controller
{
	...
	*/
	...
	public function newsupdate_put($id)
    {
		$this->load->model('newsupdatemodel');
		$result = $this->newsupdatemodel->update_newsupdate($id,$this->put());
		if($result)
		{
			$this->response(array('success' => 'Record updated!'), 200); // 200 being the HTTP response code
		}
		else
		{
			$this->response(array('error' => 'No news found!'), 404);
